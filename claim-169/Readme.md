...
| 8         | tstr  | Date of Birth        | Date of birth of the citizen                                                                                                                                                                                                    |
...
| 14        | tstr  | Marital Status       | Marital status of the citizen                                                                                                                                                                                                   |
...
| 17        | [int] | Best Quality Fingers | An unsigned 8-bit number encoding hand position of the finger. It must be in range 0-10, where 0 represents "Unknown", 1-5 represents right thumb to little finger, and 6-10 represents left thumb to little finger in sequence |
| 18        | tstr  |                      | Reserved for future attributes                                                                                                                                                                                                  |
